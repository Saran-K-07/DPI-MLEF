...
| Mode | On-site |
| Duration | 15 Days |
| Main In-Charge | [Mr. Noor Mahammad Sk](https://www.linkedin.com/in/noor-mahammad-sk-494a9211/) |
| Task Supervisor | [Mr. Mohit Bhasme](https://www.linkedin.com/in/mohit-bhasme-8263891b1/) |
| Work | Developing Exploit code for Dynamic Analysis Research Work |

# Dynamic Instrumentation
This is an Automated Tool which run the exploit code in a Docker Container and Collect Strace Logs

# Getting Started
### Dependencies
- An Virtual Machine
- Ubuntu or any other Ubuntu-Based Linux Distro
- Docker
...
```bash
git clone https://github.com/Saran-K-07/Dynamic-Instrumentation
```
Now Open this Cloned Folder either in VS Code or VS Codium
